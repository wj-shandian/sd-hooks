...
export default function DumiContextWrapper() {
  ...
  return (
    <SiteContext.Provider value={{
      ...
      setLoading,
      hostname: undefined,
      themeConfig: {"footer":"Copyright © 2024 | Powered by <a href=\"https://d.umijs.org\" target=\"_blank\" rel=\"noreferrer\">dumi</a>","prefersColor":{"default":"light","switch":true},"nprogress":true,"lastUpdated":true,"name":"sd-hooks","logo":"/logo.png","favicon":"/logo.png","nav":[{"title":"指南","link":"/guid"},{"title":"Hooks","link":"/hooks"}],"sidebar":{"/hooks":[{"title":"状态","children":[{"title":"1","link":"/hooks/useToggle/index"}]}]}},
